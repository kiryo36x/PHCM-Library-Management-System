...
{
    public class CatanaDatePicker : DateTimePicker
    {
        ...
        //Constructor
        public CatanaDatePicker()
        {
            this.SetStyle(ControlStyles.UserPaint, true);
            this.MinimumSize = new Size(0, 35);
            this.Font = new Font(this.Font.Name, 9.5F);           
            // Attach LostFocus event
            this.LostFocus += CatanaDatePicker_LostFocus;
        }
        ...
        private void CatanaDatePicker_LostFocus(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(this.Text) || this.CustomFormat == " ")
            {
                this.CustomFormat = " "; // Hide text
            }
        }
