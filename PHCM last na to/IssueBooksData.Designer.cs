...
namespace PHCM_last_na_to.IssueBooksDataTableAdapters {
...
SELECT id, bookName, author, studentName, publishedDate, issueDate FROM issue WHERE (id = @id)";
        ...
        public virtual int Fill(IssueBooksData.issueDataTable dataTable) {
        ...
        public virtual IssueBooksData.issueDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IssueBooksData.issueDataTable dataTable = new IssueBooksData.issueDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IssueBooksData.issueDataTable dataTable) {
