...
namespace PHCM_last_na_to {
    ...
    public partial class IssuedBooks : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/IssuedBooks.xsd";
        ...
        public partial class issueDataTable : global::System.Data.TypedTableBase<issueRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public issueRow AddissueRow(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, string genre) {
...
namespace PHCM_last_na_to.IssuedBooksTableAdapters {
    ...
    public partial class issueTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[issue] ([bookName], [author], [studentName], [publishedDate], [issueDate], [genre]) VALUES (@bookName, @author, @studentName, @publishedDate, @issueDate, @genre);
SELECT id, bookName, author, studentName, publishedDate, issueDate, genre FROM issue WHERE (id = SCOPE_IDENTITY())";
...
SELECT id, bookName, author, studentName, publishedDate, issueDate, genre FROM issue WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, bookName, author, studentName, publishedDate, issueDate, genre FROM db" +
                "o.issue";
        ...
        public virtual int Insert(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, string genre) {
            if ((bookName == null)) {
        ...
        public virtual int Update(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, string genre, int Original_id, string Original_bookName, string Original_author, string Original_studentName, System.DateTime Original_publishedDate, System.DateTime Original_issueDate, string Original_genre, int id) {
            if ((bookName == null)) {
                throw new global::System.ArgumentNullException("bookName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_publishedDate));
        ...
        public virtual int Update(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, string genre, int Original_id, string Original_bookName, string Original_author, string Original_studentName, System.DateTime Original_publishedDate, System.DateTime Original_issueDate, string Original_genre) {
            return this.Update(bookName, author, studentName, publishedDate, issueDate, genre, Original_id, Original_bookName, Original_author, Original_studentName, Original_publishedDate, Original_issueDate, Original_genre, Original_id);
        }
    }
