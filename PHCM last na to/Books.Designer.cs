...
namespace PHCM_last_na_to {
    ...
    public partial class Books : global::System.Data.DataSet {
        ...
        public partial class booksDataTable : global::System.Data.TypedTableBase<booksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public booksRow AddbooksRow(string bookName, string author, System.DateTime datePick, long quantity, string bookPicture, byte[] picture, string genre) {
...
namespace PHCM_last_na_to.BooksTableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[books] WHERE (([id] = @Original_id) AND ([bookName] = @Original_bookName) AND ([author] = @Original_author) AND ([datePick] = @Original_datePick) AND ([quantity] = @Original_quantity) AND ([bookPicture] = @Original_bookPicture) AND ([genre] = @Original_genre))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[books] ([bookName], [author], [datePick], [quantity], [bookPicture], [picture], [genre]) VALUES (@bookName, @author, @datePick, @quantity, @bookPicture, @picture, @genre);
SELECT id, bookName, author, datePick, quantity, bookPicture, picture, genre FROM books WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[books] SET [bookName] = @bookName, [author] = @author, [datePick] = @datePick, [quantity] = @quantity, [bookPicture] = @bookPicture, [picture] = @picture, [genre] = @genre WHERE (([id] = @Original_id) AND ([bookName] = @Original_bookName) AND ([author] = @Original_author) AND ([datePick] = @Original_datePick) AND ([quantity] = @Original_quantity) AND ([bookPicture] = @Original_bookPicture) AND ([genre] = @Original_genre));
SELECT id, bookName, author, datePick, quantity, bookPicture, picture, genre FROM books WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, bookName, author, datePick, quantity, bookPicture, picture, genre FROM" +
                " dbo.books";
        ...
        public virtual int Delete(int Original_id, string Original_bookName, string Original_author, System.DateTime Original_datePick, long Original_quantity, string Original_bookPicture, string Original_genre) {
        ...
        public virtual int Insert(string bookName, string author, System.DateTime datePick, long quantity, string bookPicture, byte[] picture, string genre) {
            if ((bookName == null)) {
        ...
        public virtual int Update(string bookName, string author, System.DateTime datePick, long quantity, string bookPicture, byte[] picture, string genre, int Original_id, string Original_bookName, string Original_author, System.DateTime Original_datePick, long Original_quantity, string Original_bookPicture, string Original_genre, int id) {
            if ((bookName == null)) {
                throw new global::System.ArgumentNullException("bookName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_datePick));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((long)(Original_quantity));
            if ((Original_bookPicture == null)) {
                throw new global::System.ArgumentNullException("Original_bookPicture");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_bookPicture));
            }
            if ((Original_genre == null)) {
                throw new global::System.ArgumentNullException("Original_genre");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string bookName, string author, System.DateTime datePick, long quantity, string bookPicture, byte[] picture, string genre, int Original_id, string Original_bookName, string Original_author, System.DateTime Original_datePick, long Original_quantity, string Original_bookPicture, string Original_genre) {
            return this.Update(bookName, author, datePick, quantity, bookPicture, picture, genre, Original_id, Original_bookName, Original_author, Original_datePick, Original_quantity, Original_bookPicture, Original_genre, Original_id);
        }
    }
