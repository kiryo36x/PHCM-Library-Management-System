...
namespace PHCM_last_na_to {
    ...
    public partial class ReturnBooks : global::System.Data.DataSet {
        ...
        public partial class returnBookDataTable : global::System.Data.TypedTableBase<returnBookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public returnBookRow AddreturnBookRow(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, System.DateTime returnDate, string condition, string genre) {
...
namespace PHCM_last_na_to.ReturnBooksTableAdapters {
    ...
    public partial class returnBookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[returnBook] ([bookName], [author], [studentName], [publishedDate], [issueDate], [returnDate], [condition], [genre]) VALUES (@bookName, @author, @studentName, @publishedDate, @issueDate, @returnDate, @condition, @genre);
SELECT id, bookName, author, studentName, publishedDate, issueDate, returnDate, condition, genre FROM returnBook WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[returnBook] SET [bookName] = @bookName, [author] = @author, [studentName] = @studentName, [publishedDate] = @publishedDate, [issueDate] = @issueDate, [returnDate] = @returnDate, [condition] = @condition, [genre] = @genre WHERE (([id] = @Original_id) AND ([bookName] = @Original_bookName) AND ([author] = @Original_author) AND ([studentName] = @Original_studentName) AND ([publishedDate] = @Original_publishedDate) AND ([issueDate] = @Original_issueDate) AND ([returnDate] = @Original_returnDate) AND ([condition] = @Original_condition) AND ([genre] = @Original_genre));
SELECT id, bookName, author, studentName, publishedDate, issueDate, returnDate, condition, genre FROM returnBook WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, bookName, author, studentName, publishedDate, issueDate, returnDate, c" +
                "ondition, genre FROM dbo.returnBook";
        ...
        public virtual int Fill(ReturnBooks.returnBookDataTable dataTable) {
        ...
        public virtual ReturnBooks.returnBookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ReturnBooks.returnBookDataTable dataTable = new ReturnBooks.returnBookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ReturnBooks.returnBookDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ReturnBooks dataSet) {
        ...
        public virtual int Insert(string bookName, string author, string studentName, System.DateTime publishedDate, System.DateTime issueDate, System.DateTime returnDate, string condition, string genre) {
            if ((bookName == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((System.DateTime)(Original_publishedDate));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_issueDate));
            this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTime)(Original_returnDate));
            if ((Original_condition == null)) {
                throw new global::System.ArgumentNullException("Original_condition");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_condition, 
                    string Original_genre) {
            return this.Update(bookName, author, studentName, publishedDate, issueDate, returnDate, condition, genre, Original_id, Original_bookName, Original_author, Original_studentName, Original_publishedDate, Original_issueDate, Original_returnDate, Original_condition, Original_genre, Original_id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(ReturnBooks dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._returnBookTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(ReturnBooks dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._returnBookTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(ReturnBooks dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._returnBookTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(ReturnBooks dataSet) {
            if ((dataSet == null)) {
