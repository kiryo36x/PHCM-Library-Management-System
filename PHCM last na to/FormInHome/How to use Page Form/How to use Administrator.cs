...
{
    public partial class How_to_use_Administrator: Form
    {
        private Form currentChildForm;
        private int switchImage = 1;
        public How_to_use_Administrator()
        {
            InitializeComponent();
        ...
        {            
            if (sender is PictureBox pc)
            {
                if (pc.Name == "nextbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.administrator_2;
                        count.Text = "2/3";
                    }
                    else if (switchImage == 3)
                    {
                        admin1.Image = Properties.Resources.administrator_3;
                        count.Text = "3/3";
                    }                   
                }
                else if (pc.Name == "previousbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.administrator_1;
                        count.Text = "1/3";
                    }                    
                }
            }
