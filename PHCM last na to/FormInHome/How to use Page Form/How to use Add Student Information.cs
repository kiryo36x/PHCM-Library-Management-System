...
{
    public partial class How_to_use_Add_Student_Information: Form
    {
        private Form currentChildForm;
        private int switchImage = 1;
        public How_to_use_Add_Student_Information()
        {
            InitializeComponent();
        ...
        private void clicked(object sender, EventArgs e)
        {
            if (sender is PictureBox pc)
            {
                if (pc.Name == "nextbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.Add_student_Information_2;
                        count.Text = "2/2";
                    }                    
                }
                else if (pc.Name == "previousbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.Add_student_Information_1;
                        count.Text = "1/2";
                    }
                }
            }
