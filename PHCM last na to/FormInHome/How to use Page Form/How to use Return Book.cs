...
{
    public partial class How_to_use_Return_Book: Form
    {
        private Form currentChildForm;
        private int switchImage = 1;
        public How_to_use_Return_Book()
        {
            InitializeComponent();
        ...
        private void clicked(object sender, EventArgs e)
        {
            if (sender is PictureBox pc)
            {
                if (pc.Name == "nextbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.issued_book_3;
                        count.Text = "2/2";
                    }
                }
                else if (pc.Name == "previousbutton")
                {
                    ...
                    {
                        admin1.Image = Properties.Resources.issued_book_4;
                        count.Text = "1/2";
                    }
                }
            }
