...
{
    public partial class About_Us_Second: Form
    {
        private Form currentChildForm;
        public About_Us_Second()
        {
            InitializeComponent();
        ...
        private void entered(object sender, EventArgs e)
        {
            if (sender is PictureBox pc)
            {
                ...
                //else if (pc.Name == "AdorioProfile")
                //{
                //    pc.Image = Properties.Resources.HoveredAdorio1;
                //    Cursor = Cursors.Hand;
                //}
                //else if (pc.Name == "AuroraProfile")
                //{
                //    pc.Image = Properties.Resources.HoveredAurora;
                //    Cursor = Cursors.Hand;
                //}
                //else if (pc.Name == "BlacoProfile")
                //{
                //    pc.Image = Properties.Resources.HoveredBlaco;
                //    Cursor = Cursors.Hand;
                //}
                //else if (pc.Name == "CatanaProfile")
                //{
                //    pc.Image = Properties.Resources.HoveredCatana;
                //    Cursor = Cursors.Hand;
                //}
            }
            else if (sender is Label lbl)
        ...
        private void leaved(object sender, EventArgs e)
        {
            ...
            AdorioProfile.Image = Properties.Resources.DefaultAdorio1;
            AuroraProfile.Image = Properties.Resources.DefaultAurora;
            BlacoProfile.Image = Properties.Resources.DefaultBlaco;
            CatanaProfile.Image = Properties.Resources.DefaultCatana;
