...
{
    public partial class EmptyField : Form
    {
        int emptyfieldX, emptyfieldY; // Declaring two variables to hold the X and Y coordinates of the form.

        public EmptyField() // This is the constructor method, it's called when the form is created.
        {
            InitializeComponent(); // Initializes all the components (buttons, labels, etc.) of the form.
        }

        private void EmptyField_Load(object sender, EventArgs e) // This method runs when the form is loaded.
        {
            Position(); // Calls the Position method to set the initial position of the form on the screen.
        }
