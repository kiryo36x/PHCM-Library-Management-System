...
{
    public partial class StudentNumberAlreadyExist: Form
    {
        int StudentNumberX, StudentNumberY;
        public StudentNumberAlreadyExist()
        {
            InitializeComponent();
        }
        ...
        private void StudentNumberAlreadyExist_Load(object sender, EventArgs e)
        {
